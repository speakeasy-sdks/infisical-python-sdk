...
class Secret:
    ...
    secret_comment_ciphertext: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('secretCommentCiphertext'), 'exclude': lambda f: f is None }})
    secret_comment_iv: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('secretCommentIV'), 'exclude': lambda f: f is None }})
    secret_comment_tag: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('secretCommentTag'), 'exclude': lambda f: f is None }})
